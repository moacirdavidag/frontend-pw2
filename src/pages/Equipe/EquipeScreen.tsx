  ...
  return (
    <Box p={5} maxW="1200px" mx="auto">
      ...
      <Text color="#717171" fontSize="16px" mb={6} textAlign="center">
        Somos alunos do IFPB - Campus Cajazeiras, Estudantes de Analise e
        Desenvolvimento de Sistemas e desenvolvemos um sistema de Delivery para
        facilitar a vida dos nossos usuários. <br />
      </Text>
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <Link href={member.github} isExternal>
              <Button leftIcon={<FaGithub />} colorScheme="red" variant="solid">
                GitHub
              </Button>
            </Link>
          </Box>
