import { Box, FormControl, FormLabel, Input, Textarea, VStack, Image, Heading, Text } from "@chakra-ui/react";
...
const Contato = () => {
    return (
        <Box p={5} maxW="600px" mx="auto">
            ...
            {/* Título da página */}
            <Heading as="h1" color="red.500" fontSize="24px" fontWeight="semibold" mb={4} textAlign="center">
                Entre em Contato Conosco
            </Heading>

            {/* Texto de boas-vindas */}
            <Text color="#717171" fontSize="16px" mb={6} textAlign="center">
                Tem alguma dúvida ou sugestão? Preencha o formulário abaixo e responderemos o mais breve possível!
            </Text>
